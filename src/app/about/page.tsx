...
const TechGrid = dynamic(() => import('@/components/TechGrid'));

export const metadata = {
  title: 'About Us | CoreDigital',
  description: 'We are a premium software house dedicated to transforming complex business challenges into elegant, scalable digital solutions.',
};
        ...
        <section className="section-padding">
            <Container>
                ...
                <Row className="g-4">
                    {values.map((val, idx) => (
                        <Col key={idx} md={6}>
                            <div className="h-100" style={{ transition: 'transform 0.3s ease' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
